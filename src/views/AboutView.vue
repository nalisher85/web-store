...
<template>
    <div class="p-4 pb-24 max-w-screen-sm mx-auto">
        ...
        <p class="text-sm opacity-80 mb-6">
            Мы — интернет-магазин строительных материалов. Сейчас проект работает в тестовом режиме: мы постепенно наполняем каталог и расширяем ассортимент. 
            Если вы не нашли нужный товар — напишите нам, и мы постараемся помочь.
        </p>
